...
// @connect      localhost
// @connect      *
// @updateURL    https://raw.githubusercontent.com/Mikmail02/Alt-manager/main/altacc.js
// @downloadURL  https://raw.githubusercontent.com/Mikmail02/Alt-manager/main/altacc.js
...
(function() {
        ...
        while (remaining > 0) {
            ...
            for (let tries = 0; tries < 5; tries++) {
                try {
                    ...
                    const backoff = (res.status === 403 || res.status === 429 || res.status >= 500)
                        ? 800 * (tries + 1)
                        : 180;
    ...
    /** Fetch URL and parse JSON safely. Retries on HTML response, 403, 429, or 5xx. Avoids "Unexpected token '<'" when server returns error page. */
